...
<head>
    ...
    <title>Something Went Wrong - KASS Care</title>
...
<body class="min-h-screen bg-gray-100 flex items-center justify-center px-6">
    <div class="max-w-xl w-full bg-white shadow-xl rounded-2xl border border-gray-200 p-10 text-center">
        ...
        <h1 class="text-3xl font-extrabold text-gray-900 mb-3">Something went wrong</h1>
        <p class="text-gray-600 mb-8">
            We hit a system problem. Please try again in a moment.
        </p>
