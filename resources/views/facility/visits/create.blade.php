    ...
    <div class="max-w-5xl mx-auto px-6 py-10">
        ...
        <div class="rounded-3xl border border-slate-800 bg-slate-900/80 shadow-2xl p-8">
            <form method="POST" action="{{ route('facility.visits.store') }}" class="space-y-6">
                ...
                <div>
                    <label for="client_id" class="block text-sm font-semibold text-slate-300 mb-2">Client</label>
                ...
                <div>
                    <label for="provider_id" class="block text-sm font-semibold text-slate-300 mb-2">Provider</label>
                ...
                <div>
                    <label for="caregiver_id" class="block text-sm font-semibold text-slate-300 mb-2">Caregiver</label>
                ...
                <div>
                    <label for="visit_date" class="block text-sm font-semibold text-slate-300 mb-2">Visit Date</label>
                    <input type="date"
                           name="visit_date"
                           id="visit_date"
