...
<div class="max-w-6xl mx-auto px-6 py-10">
    <div class="bg-white rounded-2xl shadow-sm border border-indigo-100 p-6">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Providers</h1>
                <p class="text-gray-600 mt-1">Manage provider accounts and facility assignments.</p>
            </div>
                ...
                <tbody>
                    @forelse($providers as $provider)
                        <tr class="border-b border-gray-100 hover:bg-indigo-50 transition">
                            ...
                            <td class="py-4 px-4 text-gray-700">
                                {{ $provider->facility->name ?? 'Not assigned' }}
                            </td>
                            <td class="py-4 px-4">
