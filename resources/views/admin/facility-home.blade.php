    ...
    <button type="submit"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div class="rounded-2xl bg-slate-950 border border-slate-800 p-5">
                        ...
                        <p class="text-2xl font-semibold mt-3">
                            {{ auth()->user()->facility?->name ?? 'Not provided' }}
                        </p>
                    </div>
                    ...
                    <div class="rounded-2xl bg-slate-950 border border-slate-800 p-5">
                        ...
                        <p class="text-2xl font-semibold mt-3">
                            {{ auth()->user()->facility?->address ?? 'Not provided' }}
                        </p>
                    </div>
                    ...
                    <div class="rounded-2xl bg-slate-950 border border-slate-800 p-5">
                        ...
                        <p class="text-2xl font-semibold mt-3">
                            {{ auth()->user()->facility?->phone ?? 'Not provided' }}
                        </p>
                    </div>
            ...
            <div class="rounded-3xl bg-slate-900 border border-slate-800 p-8">
                ...
                <p class="text-slate-400 mb-6">Jump into related facility workflows.</p>

                <div class="space-y-3">
                    <a href="{{ route('facility.patients.index') }}"
                       class="block w-full text-center px-4 py-4 rounded-2xl bg-indigo-600 text-white font-semibold hover:bg-indigo-700 transition">
                        Open Clients
                    </a>

                    <a href="{{ route('facility.caregivers.index') }}"
                       class="block w-full text-center px-4 py-4 rounded-2xl border border-slate-700 text-slate-300 font-semibold hover:bg-slate-800 transition">
                        Open Caregivers
                    </a>
